...
import authservice.security.JwtAuthenticationFilter;
import authservice.security.RestAccessDeniedHandler;
import authservice.security.RestAuthenticationEntryPoint;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.csrf(csrf -> csrf.disable())
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/users/avatar/**").permitAll().requestMatchers("/api/**").authenticated()
